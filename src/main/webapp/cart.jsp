<%-- 
    Document   : cart
    Created on : Mar 25, 2022, 7:53:09 PM
    Author     : XuanQuy
--%>
                            ...
                            <table class="table">
                                ...
                                <form action="CartController" method="post">
                                    ...
                                    <td >
                                        <form action="CartController" method="post">
                                            <input type="hidden" name="id" value="<%= item.getMaSp()%>"/>
                                            <button style="background-color: whitesmoke" type="submit" name="cart" value="add" class="btn btn-info btn-block">
                                                <small>+</small
                                            </button>
                                        </form>
                                    </td>
                                ...
                                <p class="tongTien"><strong >Tổng tiền:  <fmt:formatNumber type="number" maxFractionDigits="2" value="<%= cart.getTongTien()%>" /> VNĐ<strong></p>
                                            ...
                                            <p style="margin-top: 50px" class="text-center"><a href="CheckoutController" class="btn btn-primary py-3 px-4">Proceed to Checkout</a></p>
