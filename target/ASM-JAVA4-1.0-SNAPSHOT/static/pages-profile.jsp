<%-- 
    ...
    Created on : Mar 25, 2022, 10:28:15 AM
    Author     : XuanQuy
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <meta name="keywords" content="adminkit, bootstrap, bootstrap 5, admin, dashboard.jsp, template, responsive, css, sass, html, theme, front-end, ui kit, web">

        <link rel="preconnect" href="https://fonts.gstatic.com">
        <link rel="shortcut icon" href="img/icons/react.png" />

        <link rel="canonical" href="https://demo-basic.adminkit.io/pages-profile.jsp" />
                        ...
                        <ul class="navbar-nav navbar-align">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a class="dropdown-item" href="pages-profile.jsp"><i class="align-middle me-1" data-feather="user"></i> Profile</a>
                            ...
                            <div class="col-md-4 col-xl-3">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body text-center">
                                        <img src="img/avatars/avt.jpg" alt="Christina Mason" class="img-fluid rounded-circle mb-2" width="128" height="128" />
                                        <h5 class="card-title mb-0"> <%=name%> </h5>
                                        <div class="text-muted mb-2">Leader Developer</div>
