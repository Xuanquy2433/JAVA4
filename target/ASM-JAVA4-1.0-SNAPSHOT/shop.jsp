<%-- 
    Document   : shop
    Created on : Mar 24, 2022, 9:19:10 PM
    Author     : XuanQuy
--%>
                                        ...
                                        <div class="text py-3 px-3">
                                            ...
                                            <div class="d-flex">
                                                <div class="pricing">
                                                    ...
                                                    <p style="color: #080808" class="price-sale"> <fmt:formatNumber value = "${cat.getPrice()}" 
                                                                      type = "currency"/> </p>
                                                </div>
                                                <div class="rating">
                                                    <p class="text-right">
                    ...
                    <div class="col-md">
                        <div class="ftco-footer-widget mb-4">
                            ...
                            <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                                ...
                                <li class="ftco-animate"><a href="https://www.youtube.com/watch?v=Dvf9fJkyf10"><span class="icon-instagram"></span></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md">
